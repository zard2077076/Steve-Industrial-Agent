...
public final class CreateV606CuttingRuntimeObserver implements CreateV606RuntimeObserver {
    ...
    public CapabilityObservationResult observe(ServerLevel level, String runtime, String world,
        ...
        return delegate.observe(level, runtime, world, request, semantics, Set.of(CreateCapabilityId.CUTTING));
    }
}
