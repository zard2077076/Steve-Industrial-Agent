...
public final class CreateV606CrushingRuntimeObserver implements CreateV606RuntimeObserver {
    ...
    public CapabilityObservationResult observe(ServerLevel level, String runtime, String world,
        ...
        return delegate.observe(level, runtime, world, request, semantics, Set.of(CreateCapabilityId.CRUSHING));
    }
}
