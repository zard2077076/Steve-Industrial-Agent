...
`0.1.0-alpha.1` 当前验证边界：Windows 11、Java 17、Minecraft 1.20.1、
...
其他启动器可能可以工作，但尚未声明验证通过。Linux、Mekanism-only、
Create+Mekanism、其他 Minecraft/Forge/Create 版本均不在本 Alpha 支持矩阵。
