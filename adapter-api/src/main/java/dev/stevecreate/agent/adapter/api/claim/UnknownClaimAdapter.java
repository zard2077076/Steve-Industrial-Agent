...
public final class UnknownClaimAdapter implements ClaimAdapter {
    private static final ResourceId ID = ResourceId.parse("generic:unknown-claim");
    ...
    public PermissionEvidence query(PermissionQuery query) {
        ...
        return ClaimEvidenceFactory.create(
                query, PermissionDecision.UNKNOWN, PermissionEvidenceState.UNVERIFIED,
                ID, "generic:unknown", "no authoritative claim decision");
    }
}
